...
static inline const DdsPixelFormat& getDdsPixelFormat( TextureFormat::Enum _format )
{
	...
	if( TextureFormat::BGR8    == _format )
	{
		return s_ddsPixelFormat[0];
	}
	else if( TextureFormat::BGRA8   == _format )
	{
		return s_ddsPixelFormat[1];
	}
	else if( TextureFormat::RGBA16  == _format )
	{
		return s_ddsPixelFormat[2];
	}
	else if( TextureFormat::RGBA16F == _format )
	{
		return s_ddsPixelFormat[3];
	}
	else/*(TextureFormat::RGBA32F == _format)*/
	{
		return s_ddsPixelFormat[4];
	}
}

static inline uint8_t getDdsDxgiFormat( TextureFormat::Enum _format )
{
	if( TextureFormat::RGBA16  == _format )
	{
	...
	else if( TextureFormat::RGBA32F == _format )
	{
...
void toRgba32f( float _rgba32f[4], TextureFormat::Enum _srcFormat, const void* _src )
{
	switch( _srcFormat )
	{
		case TextureFormat::BGR8:
			bgr8ToRgba32f( _rgba32f, ( const  uint8_t* )_src );
			break;
		case TextureFormat::RGB8:
			rgb8ToRgba32f( _rgba32f, ( const  uint8_t* )_src );
			break;
		case TextureFormat::RGB16:
			rgb16ToRgba32f( _rgba32f, ( const uint16_t* )_src );
			break;
		case TextureFormat::RGB16F:
			rgb16fToRgba32f( _rgba32f, ( const uint16_t* )_src );
			break;
		case TextureFormat::RGB32F:
			rgb32fToRgba32f( _rgba32f, ( const    float* )_src );
			break;
		case TextureFormat::RGBE:
			rgbeToRgba32f( _rgba32f, ( const  uint8_t* )_src );
			break;
		case TextureFormat::BGRA8:
			bgra8ToRgba32f( _rgba32f, ( const  uint8_t* )_src );
			break;
		case TextureFormat::RGBA8:
			rgba8ToRgba32f( _rgba32f, ( const  uint8_t* )_src );
			break;
		case TextureFormat::RGBA16:
			rgba16ToRgba32f( _rgba32f, ( const uint16_t* )_src );
			break;
		case TextureFormat::RGBA16F:
			rgba16fToRgba32f( _rgba32f, ( const uint16_t* )_src );
			break;
		case TextureFormat::RGBA32F:
			rgba32fToRgba32f( _rgba32f, ( const    float* )_src );
			break;
		default:
...
void fromRgba32f( void* _out, TextureFormat::Enum _format, const float _rgba32f[4] )
{
	...
	{
		case TextureFormat::BGR8:
			bgr8FromRgba32f( ( uint8_t* )_out,     _rgba32f );
			break;
		case TextureFormat::RGB8:
			rgb8FromRgba32f( ( uint8_t* )_out,     _rgba32f );
			break;
		case TextureFormat::RGB16:
			rgb16FromRgba32f( ( uint16_t* )_out,   _rgba32f );
			break;
		case TextureFormat::RGB16F:
			rgb16fFromRgba32f( ( uint16_t* )_out,  _rgba32f );
			break;
		case TextureFormat::RGB32F:
			rgb32fFromRgba32f( ( float* )_out,     _rgba32f );
			break;
		case TextureFormat::RGBE:
			rgbeFromRgba32f( ( uint8_t* )_out,     _rgba32f );
			break;
		case TextureFormat::BGRA8:
			bgra8FromRgba32f( ( uint8_t* )_out,    _rgba32f );
			break;
		case TextureFormat::RGBA8:
			rgba8FromRgba32f( ( uint8_t* )_out,    _rgba32f );
			break;
		case TextureFormat::RGBA16:
			rgba16FromRgba32f( ( uint16_t* )_out,  _rgba32f );
			break;
		case TextureFormat::RGBA16F:
			rgba16fFromRgba32f( ( uint16_t* )_out, _rgba32f );
			break;
		case TextureFormat::RGBA32F:
			rgba32fFromRgba32f( ( float* )_out,    _rgba32f );
			break;
		default:
			DEBUG_CHECK( false, "Unknown image format." );
	};
